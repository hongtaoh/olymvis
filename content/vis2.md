...
{{<figure src="/pics/g-2-6.png"  caption="Figure 28: Line graph in small multiple for female participation by continent against global statistics" class="fullwidth">}}
...
var figure27 = {
  ...
  "signals": [
    ...
    {
      "name": "selector074",
      "update": "vlSelectionResolve(\"selector074_store\", \"union\")"
    },
    {
      "name": "selector074_Year",
      "on": [
        {
          "events": {"signal": "selector074_translate_delta"},
          "update": "panLinear(selector074_translate_anchor.extent_x, -selector074_translate_delta.x / width)"
        },
        {
          "events": {"signal": "selector074_zoom_delta"},
          "update": "zoomLinear(domain(\"x\"), selector074_zoom_anchor.x, selector074_zoom_delta)"
        },
        {"events": [{"source": "scope", "type": "dblclick"}], "update": "null"}
      ]
    },
    {
      "name": "selector074_Female_Percentage",
      "on": [
        {
          "events": {"signal": "selector074_translate_delta"},
          "update": "panLinear(selector074_translate_anchor.extent_y, selector074_translate_delta.y / height)"
        },
        {
          "events": {"signal": "selector074_zoom_delta"},
          "update": "zoomLinear(domain(\"y\"), selector074_zoom_anchor.y, selector074_zoom_delta)"
        },
        {"events": [{"source": "scope", "type": "dblclick"}], "update": "null"}
      ]
    },
    {
      "name": "selector074_tuple",
      "on": [
        {
          "events": [
            {"signal": "selector074_Year || selector074_Female_Percentage"}
          ],
          "update": "selector074_Year && selector074_Female_Percentage ? {unit: \"\", fields: selector074_tuple_fields, values: [selector074_Year,selector074_Female_Percentage]} : null"
        }
      ]
    },
    {
      "name": "selector074_tuple_fields",
      "value": [
    ...
    {
      "name": "selector074_translate_anchor",
      "value": {},
      "on": [
        {
    ...
    {
      "name": "selector074_translate_delta",
      "value": {},
      "on": [
        {
          "events": [
          ...
          "update": "{x: selector074_translate_anchor.x - x(unit), y: selector074_translate_anchor.y - y(unit)}"
        }
      ]
    },
    {
      "name": "selector074_zoom_anchor",
      "on": [
        {
    ...
    {
      "name": "selector074_modify",
      "on": [
        {
          "events": {"signal": "selector074_tuple"},
          "update": "modify(\"selector074_store\", selector074_tuple, true)"
        }
      ]
    }
  ],
  ...
  "scales": [
    {
      ...
      "domainRaw": {"signal": "selector074[\"Year\"]"},
    ...
    },
    {
      ...
      "domainRaw": {"signal": "selector074[\"Female_Percentage\"]"},
