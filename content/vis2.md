...
var figure27 = {
  ...
  "signals": [
    ...
    {
      "name": "selector002_Percentage_decimal",
      "on": [
        {
          "events": {"signal": "selector002_translate_delta"},
    ...
    },
    {
      ...
      "on": [
        {
          "events": [
            {"signal": "selector002_Year || selector002_Percentage_decimal"}
          ],
          "update": "selector002_Year && selector002_Percentage_decimal ? {unit: \"\", fields: selector002_tuple_fields, values: [selector002_Year,selector002_Percentage_decimal]} : null"
        }
      ]
    },
    {
  ...
  "scales": [
    {
      ...
      "domainRaw": {"signal": "selector002[\"Year\"]"},
    ...
    },
    {
      ...
      "domainRaw": {"signal": "selector002[\"Percentage_decimal\"]"},
